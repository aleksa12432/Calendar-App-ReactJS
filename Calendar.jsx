    ...
    <div className="container mx-auto">
      <nav class="mx-0 h-20 flex content-center justify-center m-0 border-b-1 shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
          <div class="flex items-center justify-center gap-16 sm:justify-start">
      ...
      <div className="flex flex-col gap-10 sm:divide-x justify-center mx-auto my-0 h-screen w-full items-center sm:flex-col relative">
        ...
        {modalVisible && (
          <section className="modal-container">
            <form name="oglas" class="post-name-container ">
              <h3>Dodaj novi dogadjaj</h3>
              <input
              value ={imeDogadjaja} onChange ={(e) => setimeDogadjaja(e.target.value)}
                id="post-name"
                name="name"
              ...
              <input
              value ={beleska} onChange ={(e) => setBeleska(e.target.value)}
                id="post-name"
                name="beleska"
                placeholder="Dodaj belešku..."
              ></input>

              <input value ={datum} onChange ={(e) => setDatum(e.target.value)} type="date" id="post-date" />
              <div className="flex gap-5 justify-center">
                <input
              value ={pocetak} onChange ={(e) => setPocetak(e.target.value)}
                  id="post-time"
                  name="vreme"
                  placeholder="Početak"
                ></input>
                <input value ={kraj} onChange ={(e) => setKraj(e.target.value)} id="post-time" name="vreme" placeholder="Kraj"></input>
              </div>
